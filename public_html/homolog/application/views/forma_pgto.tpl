<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs nav-tabs-2" role="tablist"> 
            ...
            <li><a href="#tabs-3" role="tab" data-toggle="tab"><img style="position: relative; top: 8px;" src="{$web_files}/img/assets/paypal-logo.png?v=2"></a></li>
        </ul>
        <div class="tab-content">
                    ...
                    <form name="CieloForm" id="CieloForm" onsubmit="return false" class="form-cielo" style="display:block;max-width:450px;margin: 0 auto;text-align: left;">
                        <div id="tableCielo" style="display: block;">
                            ...
                            <div class="cont-cartao">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="btn-group" data-toggle="buttons" role="tablist" style="margin-bottom: 15px;">
                                            <label class="btn btn-default active">
                                                <input type="radio" name="codigoBandeira" value="visa" checked> <img src="{$web_files}/img/assets/band_visa.png">
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="codigoBandeira" value="mastercard"> <img src="{$web_files}/img/assets/band_master.png">
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="codigoBandeira" value="amex" > <img src="{$web_files}/img/assets/band_american.png">
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="codigoBandeira" value="diners" > <img src="{$web_files}/img/assets/band_diners.png">
                                            </label>
                                            <label class="btn btn-default">
                                                <input type="radio" name="codigoBandeira" value="elo" > <img src="{$web_files}/img/assets/band_elo.png">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <input type="submit" value="Pagar" class="btn btn-primary" onclick="javascript:cielo('{$CLIENT_HIDDEN}', '{$CODCADASTRO}', '{$CODENDERECO}', '{$language}');">
            ...
            <div id="tabs-2" class="tab-pane">
                ...
                <div class='panel panel-highlight'>
                    <div class="panel-body">
                        ...
                        <button type="buttom" class="btn btn-primary" name="enviar" onclick="javascript:boleto('{$CLIENT_HIDDEN}', '{$CODCADASTRO}', '{$CODENDERECO}', '{$language}');">PAGAR COM BOLETO</button>
                    </div>
                </div>
                <div class='form-group'>
            ...
            <div id="tabs-3" class="tab-pane">
                ...
                <div class='form-group'>
                    <button type="button" id='confirm-payment-paypal' class='btn btn-primary' onclick="javascript:paypal('{$CLIENT_HIDDEN}', '{$CODCADASTRO}', '{$CODENDERECO}', '{$language}');">PAGAR COM PAYPAL</button>
                </div>
            </div>
        </div>
        {*        </form>*}
