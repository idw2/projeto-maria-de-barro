...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <br/>
            <a href="/{$language}/conta/email-aniversariantes" class="btn btn-default navbar-btn"><i class="fa fa-mail-forward"></i> Enviar E-mail com "CUPOM PROMOCIONAL" para Aniversariantes?</a>
